...
DRIVER_ID = 'com.softdev0.boot.filesystems'
DRIVER_NAME = 'SarahMemory Boot Filesystems Bridge'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_supported_filesystems', 'detect_filesystem', 'check_mount_support', 'mount_device', 'unmount_device', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_mount_ops': False, 'require_mount_confirmation': True, 'history_limit': 200}
