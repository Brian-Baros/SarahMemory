...
DRIVER_ID = 'com.softdev0.boot.pci'
DRIVER_NAME = 'SarahMemory Boot PCI/PCIe Bridge'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_devices', 'find_by_class', 'find_by_vendor', 'find_boot_critical_devices', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_lspci': True, 'history_limit': 200}
