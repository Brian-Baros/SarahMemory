...
DRIVER_ID = 'com.softdev0.boot.displaycore'
DRIVER_NAME = 'SarahMemory Boot Display Core'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_displays', 'get_framebuffer_info', 'list_modes', 'set_mode', 'get_active_display', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_mode_switch': False, 'require_mode_confirmation': True, 'history_limit': 200}
