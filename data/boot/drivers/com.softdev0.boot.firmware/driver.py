...
# -*- coding: utf-8 -*-
"""
Generated SarahMemory AiOS boot driver package.
This is a governed boot-layer bridge package intended for ./data/boot/drivers/.
"""
...
DRIVER_ID = 'com.softdev0.boot.firmware'
DRIVER_NAME = 'SarahMemory Boot Firmware Bridge'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'get_firmware_info', 'get_smbios_info', 'get_acpi_snapshot', 'list_uefi_variables', 'read_uefi_variable', 'write_uefi_variable', 'get_boot_entries', 'set_boot_next', 'get_power_state', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_dmidecode': True, 'allow_efivarfs': False, 'allow_uefi_writes': False, 'require_write_confirmation': True, 'history_limit': 200}
