...
DRIVER_ID = 'com.softdev0.boot.inputcore'
DRIVER_NAME = 'SarahMemory Boot Input Core'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_input_devices', 'find_primary_keyboard', 'find_primary_pointer', 'find_touch_devices', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'history_limit': 200}
