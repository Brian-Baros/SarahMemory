...
DRIVER_ID = 'com.softdev0.boot.recovery'
DRIVER_NAME = 'SarahMemory Boot Recovery Core'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'generate_safe_mode_profile', 'generate_recovery_profile', 'collect_recovery_snapshot', 'plan_rollback', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_rollback_actions': False, 'require_plan_confirmation': True, 'history_limit': 300}
