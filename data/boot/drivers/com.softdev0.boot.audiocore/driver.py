...
DRIVER_ID = 'com.softdev0.boot.audiocore'
DRIVER_NAME = 'SarahMemory Boot Audio Core'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_audio_devices', 'get_default_audio_routes', 'test_tone', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_test_tone': False, 'require_tone_confirmation': True, 'history_limit': 200}
