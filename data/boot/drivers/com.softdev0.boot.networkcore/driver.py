...
DRIVER_ID = 'com.softdev0.boot.networkcore'
DRIVER_NAME = 'SarahMemory Boot Network Core'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_interfaces', 'get_link_state', 'get_ip_summary', 'find_boot_network_candidates', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'history_limit': 250}
