...
DRIVER_ID = 'com.softdev0.boot.usbhost'
DRIVER_NAME = 'SarahMemory Boot USB Host Bridge'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'list_controllers', 'list_devices', 'find_install_media', 'find_boot_input_devices', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_lsusb': True, 'history_limit': 200}
