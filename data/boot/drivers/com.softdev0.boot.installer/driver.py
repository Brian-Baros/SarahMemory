...
DRIVER_ID = 'com.softdev0.boot.installer'
DRIVER_NAME = 'SarahMemory Boot Installer Core'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'validate_target', 'generate_partition_plan', 'generate_format_plan', 'generate_install_plan', 'stage_vault_plan', 'safe_stop', 'get_config', 'set_config']
DEFAULT_CONFIG = {'enabled': True, 'autoload': True, 'allow_destructive_plans': False, 'require_plan_confirmation': True, 'history_limit': 300}
