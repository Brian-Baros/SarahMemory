...
DRIVER_ID = 'com.softdev0.boot.cpuarch'
DRIVER_NAME = 'SarahMemory Boot CPU/Architecture Bridge'
SUPPORTED_ACTIONS = ['probe_backends', 'describe_capabilities', 'get_cpu_info', 'get_arch_info', 'get_virtualization_info', 'get_topology', 'safe_stop', 'get_config', 'set_config']
