 ...
 * These replace the sidebars on vertical mobile/tablet posture.
...
export function MobileDrawers() {
  ...
  if (!isMobile) return null; // never render drawers in desktop shell
  ...
  return (
    <>
      ...
      <Sheet open={leftDrawerOpen} onOpenChange={setLeftDrawerOpen}>
        <SheetContent
          side="left"
          className="w-[min(86vw,22rem)] p-0 bg-sidebar border-sidebar-border"
          {...leftSwipeHandlers}
        >
      ...
      <Sheet open={rightDrawerOpen} onOpenChange={setRightDrawerOpen}>
        <SheetContent
          side="right"
          className="w-[min(92vw,24rem)] p-0 bg-sidebar border-sidebar-border"
          {...rightSwipeHandlers}
        >
          <SheetHeader className="p-4 border-b border-sidebar-border">
