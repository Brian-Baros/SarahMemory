...
if (a.type === "avatar_toggle_voice") {
  ...
  return (
    <div className="flex h-full min-h-0 max-h-[100svh] flex-col overflow-hidden bg-background">
      {/* Header */}
      ...
      <div className="flex-1 min-h-0">
        <ScrollArea className="h-full">
          <div className="p-2 sm:p-4">
            {/* Main Avatar Display */}
            <div className="h-[min(62svh,560px)] min-h-[360px] overflow-hidden rounded-xl border border-border bg-card sm:aspect-[3/4] sm:max-h-[60vh]">
              <PreviewSurface />
            </div>
