...
class CodeGenerator:
    ...
    def generate_from_description(self, description: str, language: CodeLanguage = CodeLanguage.PYTHON) -> Optional['GeneratedCode']:
        """Generate code from natural language description"""
        try:
            logger.info(f"Generating code: {description[:100]}...")
