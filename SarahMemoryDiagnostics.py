...
REQUIRED_FILES = [
    ...
    os.path.join(config.BASE_DIR, "SarahMemoryCognitiveSelf.py"),       # CognitiveSelf     = identity/capability,
    os.path.join(config.BASE_DIR, "SarahMemoryCognitiveServices.py"),   # CognitiveServices = logic/governor,
    os.path.join(config.BASE_DIR, "SarahMemoryCognitiveThinker.py"),    # CognitiveThinker  = meaning/possibility,
    ...
    os.path.join(config.BASE_DIR, "SarahMemoryLogicCalc.py"),
