...
SML_ORGAN_METADATA = {
    ...
    "internal_only": False,
    "metadata": {"sml_adapter": "api_bridge_non_executing", "source_file": 'appcomm.py'},
}
...
def sml_diagnostics():
    return {"status": "OK", "component": 'appcomm', "sml_adapter": True, "metadata": dict(SML_ORGAN_METADATA), "health": sml_health()}
