...
?Yep The AI Train has LEFT the STATION, I have a 100 yard Lasso on the caboose car and hanging on for dear life. I might be in last place now, but I'll catchup soon enough.
?People are going to lose their jobs to AI!
?Ai is going to be intergrated everywhere?
?What data is being collected on me now?
?AI will be like Big Brother in 1984 always watching us, Ai will be used by the Government to SPY on citizens!
?AGI will beat AI and Humanity is DOOMED! , but They haven't created a true AGI system yet, What if I create it?
?As I joke to myself constantly? 
?What if I create a system to give people their own AI system? 
?WOOH! ,Did I just create SKYNET? Hold on lets Put in some Safeguards!
?As I ponder? Big-Tech Ai's become SKYNET/ the Evil MCP?/ the Matrix?/a real version of HAL2000?/Maybe Worst...WOPR..."Do you Want to Play a GAME". "How about Tic-Tac-Toe"
?We have no control over AI Data?
?The Robots are Coming?/ Yep seen that movie a few times to.. , Terminator, iRobot, 2001 Space Oddessy, Seen them all I love Sci-Fi.
?Next thing ya know we'll have the Stargate Spider like Replicators,then humaniod Blade Runner Replicators, BSG Cylons, etc. etc.
?What if we have an AI system that People can Manage?
...
?What if We want to change the way it looks and operate? What if the people have their own Ai Operating System? What will they do? Proberly be FAT and LAZY like in WALL-E.
...
?Learning AI, yep seen those Scammers on FB to, And there goes META and GOOGLE you search for something and 10000 ads pop up in your social media feed WTF. 
...
?Humanity will not embrase AI at first like they didn't accept crypto or Bitcoin at first, yet over time it will be everywhere in everything.
?The Government will attempt to put in their own Safeguards, and bullshit, it's the Governments way of saying WE ARE IN CONTROL, kinda like when they TAX'ed Crypto it was a show of power thats all think about it, Isn't that the conceptional Tyrannical Governement Concept that led to the Declaration of Indepenance? 
?Congress needs Term Limits.. Them folks take more vaction and time off and still don't do shit for the American People but TAX us to Death. I'm sure now they will be passing Bills about AI this and That and must follow this and that rule. simply cause they want to be in control and have absolutly NO Freaking Clue about it. but some Financial Lobbiest are like Put this Rule on it so we can buy this company or that chip maker and make more money and lobby more campaign money.. bullshit. - Now I'm a Patriot, An American. I love my GOD, FAMILY and COUNTRY. but I don't like Authoritism. 
Expecially when Corporations are lobbist to polticans getting rich off of Information they harvested from me without giving me any compensation, build something that will be decentrilzed something no one owns yet everyone could use. It's going to be a long road, technology is so advanced already, many people and society have already set their ways. ?Holy Shit did my Coffee maker just started speaking. Am I tripping. I hope not just been on a Coffee, Chocolate, and Nicotine High for the Last 2 weeks, My Cellphone Camera came on Took a photo and BOOM, when I searched the Gallery Nothing.. FREAKY!!!!, Now My PC system is going SUPER SLOW.. WTF!. I build my own SYSTEMS I know it's clean.. WTF is going on here.... 
?I see something here AI don't have Memory, I bet you when I start laying the foundation of this project Every AI system will copy.
?Install Microsoft Co-Pilot Sucks, It can't remember shit. I wonder Maybe a Co-pilot Clone? Nah Lets build bigger. Lets build an AI system and figure out how to give it some Memory. a way to remember past conversations, even update it's own databases? hmmm. how does memory work? maybe use a sidebar concept of chat as threads?
?What if I took all of the SciFi movies where the Machines were Evil and made a good one? One for the people , by the people? 
?Authority around the world wants to control everything. Sorry folks I'm a Home Grown Texan, 2A rights baby...,I love America and my freedom
...
other Ai systems are scraping the Web while doing research.
?Every idea I come up with now, seems to make it where I get Bing News Media about how OpenAI is doing this and that using the same concepts I just though up of. WTF, that was my Idea. Okay I can play that game.. they must have a News Feed Generator that's AI driven and AI systems are sharing data... Lets Use that to our advantage Lets create a NetworkHub system a Mesh.
I just though of 2 days a Social Media intergration not like Facebook Meta but something cooler and add in a Crypto Concept for trading goods,... And now I see a thing about SAM ALTMAN claiming it's their Idea? Ai is hungry how do we Feed it.. it's a Beast?
?WTF am I thinking it's a beast, yet even a beast can be broken and trained like a wild Dog, remember White Fang, Spirit, Flicka, Free Willy? 
?Lets Go about AI a different route? Make it Local First? everyone has their own AI system, but we're all broke, and We have no major data center, What is a DATACENTER?
?A datacenter is basically just a huge array of databases being ran off of servers extremely fast, well if I can turn my system into a server, and have the Drive Space I can create my own At Home DataCenter. Hmmm Slow? Primative? yes but still effective. 
...
?Who controls the functions? They Do? What if we did. Maybe I don't want that Function Maybe I want to Customize it for a different Task it can't understand. I want the system to understand ME, The USER. To operate the way I think, not the way it thinks I should operate. -Yeah.. FREEDOM BABY!
...
! BOOM SarahMemory, What shall it be lets start with a Ai Chat Bot/Companion Shit... It gotta be something first. We gotta have a Platform. this is gonna be a big Project. Lets call the OVERALL Factor "The SarahMemory Project" it's a Chat box, Companion, Media Center, shit it can be alot of things huh?, Remember Microsoft Co-Pilot it couldn't remember. and now since The designing Thought process of this program now all AI systems have CHAT MEMORY, and DATA MEMORY, yet I ain't getting paid! SHOW ME THE MONEY!!!! 
...
Say Hello, to --==The SarahMemory Project==-- A system that can be anything and everything dealing with AI that the the USER can Control. 
